    ...
    return (
      ...
      >
        <div className="flex flex-col space-y-4">
          <input type="text" placeholder="Nome do Pet" className="border p-2 rounded" />
          <input type="text" placeholder="Tipo" className="border p-2 rounded" />
          <input type="text" placeholder="Raça" className="border p-2 rounded" />
          <input type="text" placeholder="Gênero" className="border p-2 rounded" />
          <input type="text" placeholder="Nome do Pet" className="border p-2 rounded" />
        </div>
      </ModalBase>
    );
